...
jQuery(document).ready(function ($) {
    ...
    jQuery('body').backstretch([
        "../Content/img/benjamin-white-dl8REOo_BXU-unsplash.jpg",
        "../Content/img/colton-sturgeon-FiCPutl_aog-unsplash (1).jpg",
        "../Content/img/matthew-deltoro-LdFvvpjnB2A-unsplash.jpg"
